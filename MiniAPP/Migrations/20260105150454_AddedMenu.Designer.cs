...
namespace MiniAPP.Migrations
{
    ...
    [Migration("20260105150454_AddedMenu")]
            ...
            modelBuilder.Entity("MiniAPP.Entities.Reservation", b =>
                {
                    ...
                    b.ToTable("Reservation", null, t =>
                        {
                            t.HasCheckConstraint("CK_Reservation_GuestCount", "\"GuestCount\" >= 1");

                            t.HasCheckConstraint("CK_Reservation_ReservationDate", "\"ReservationDate\" >= CAST(NOW() AS DATE)");
                        });
                });
